...
function App() {
  ...
  return (
    <div className="w-screen h-screen p-2 flex flex-col items-center overflow-hidden">
      ...
      {/* <h1 className='text-center font-bold text-2xl m-2'>Portfolio Darin Masov</h1> */}
      {/* <h1 className='portfolio-title'>Portfolio Darin Masov</h1> */}
      <h1 className='portfolio-title'>Portfolio Darin Masov</h1>
      ...
      "/assets/Automation/Festo/EndTest.PNG",
      "/assets/Automation/Festo/EndTest1.PNG",
      "/assets/Automation/Festo/FinalTest.png",
